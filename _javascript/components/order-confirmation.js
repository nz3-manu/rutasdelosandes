...
let Whatsapp = () => (<div style={{display:"inline", fontWeight:"500", color:"black", fontWeight:"bold"}}><a href="https://api.whatsapp.com/send?phone=573113403572&text=Hola%20Ruteros%20acabo%20de%20comprar%20un%20producto">whatsapp</a></div>)
        ...
        if (polTransactionState == '4') {
            return (
                    <div className={classes.wrapPage__gracias}>
                        ...
                        <h1 className={classes.gracias_tittle}> ¡Gracias Por Tu Compra <br></br> { this.capitalize_Words(shipping_address.first_name)}! </h1>
                        ...
                        {/*<p className={classes.shippingData__tittle}> Los datos para el envío son los siguientes:</p> 
                            ...
                            Hemos envíado el recibo de compra al correo:  <span className={classes.shippingData__text_bold}> {customer.email} </span> <br></br>
                        ...
                        <div className={classes.imgCustomized}>
                               {/* <p className={classes.imgCustomized__tittle}> Recuerda siempre cuidar de la naturaleza ⛰ y disfrutar de la tranquilidad que esta nos brinda 🍃. Etiquetanos en las redes sociales usando #rutasdelosandes  </p> */}  
                                <img src={`/image/${this.countGap(shipping_address.first_name)}/thanks.jpg`} />
                        </div>
                        <div className={classes.imgCustomized__wrapButton}>
                                    <Button variant="contained" size="small" className={classes.button}>
                                        <SaveIcon className={classNames(classes.leftIcon, classes.iconSmall)} />
                                        <a download={'rutero.jpg'} href={`/image/${this.countGap(shipping_address.first_name)}/thanks.jpg`} target='_blank'> Descargar Imagen  </a>
                                    </Button>
                        </div>
                        <p className={classes.linkForm}> Etiquetanos en las redes sociales usando <span className={classes.shippingData__text_bold}> #rutasdelosandes </span> y participa en el concurso para acompañarnos en una de nuestras próximas rutas. Ver terminos y condiciones <span className={classes.shippingData__text_bold}> < a target='_blank' href="https://rutasdelosandes.com/politicas-video.html">aquí</a></span>.</p>
            ...
            return (
                <div className={classes.wrapPage__gracias}>
                     <h1 className={classes.gracias_tittle}> Los sentimos {shipping_address.first_name}</h1> <br></br>
                     <h2>Tu transacción fue declinada, si tienes alguna pregunta puedes escribirnos a nuestro <Whatsapp /> y con gusto te atenderemos. </h2>
                </div>)
        }
        else if (polTransactionState == '104') {
            return (
                <div className={classes.wrapPage__gracias}>
                   <h1 className={classes.gracias_tittle}> Los sentimos {shipping_address.first_name}, hubo un error </h1> 
                   <h2 >    
                         ¿Tienes alguna pregunta? escribenos a nuestro <Whatsapp /> y con gusto te atenderemos.
                    </h2>
                </div>)
        }    
        else { 
            return (
                <div  className={classes.wrapPage__gracias}>
                    <h1 className={classes.gracias_tittle}> Los sentimos  {shipping_address.first_name}, <br></br>  no sabemos que salió mal 😟 </h1> 
                    <h2>
