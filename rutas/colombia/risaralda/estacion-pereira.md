...
categories: colombia 
seo_title: ESTACIÓN PEREIRA | RUTAS DE LOS ANDES
excerpt: Estación Pereira, es un lugar para hacer senderismo cerca de Pereira, encontrarás naturaleza y cascadas muy cerca de la ciudad ideal para pasar una mañana con familia y amigos.
images_url: /images/rutas/colombia/risaralda/estacion
viewranger: 
author: manuel
trending: true
---
...
{% image "images/rutas/colombia/risaralda/estacion/marrana.jpg" "Aquí podemos ver una marrana con sus pasajeros; en la parte de atrás se puede ver la motocicleta la cual la impulsa" %}

__Cruzar el río cauca en "garrucha" 🚡:__ La “garrucha” es un medio de transporte que consiste en un cable grueso que cruza el río de ambas orillas al cual se adapta una polea y una caja grande de madera y acero en donde caben de 5 a 6 personas, se desliza el canasto hasta la mitad del río y las personas que van dentro de él por sus propios medios deben llegar al otro lado de la orilla impulsandose del cable grueso.

{% image "images/rutas/colombia/risaralda/estacion/garrucha.jpg" "Foto de garrucha en Estación Pereira" %}

<a name="ruta-estacion-pereira" id="ruta-estacion-pereira"></a> 

## RUTA A ESTACIÓN PEREIRA 🚶🏽🐕.

Una vez de haber cruzado el río cauca en la “Garrucha”, llegamos a una finca donde aprovechamos para tomar algo y continuar nuestro recorrido a las cascadas que están a 30 minutos caminando, pasamos por unos potreros y después por un bosque, para finalmente llegar a la cascada.
