...
{% include image.html,
   ...
   caption:"aquí podemos ver una marrana con sus pasajeros en la parte de atrás se puede ver la 🛵 motocicleta la cual impulsa",
   width:"800",
   zoom:"13",
   height:"704"
%} 
...
{% include image.html,
   ...
   caption:"Foto de garrucha en estación pereira ",
   width:"800",
   height:"450"
%} 
