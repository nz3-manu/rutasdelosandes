...
La historia dice que antes de ser construida la capilla, emanaba en este lugar agua desde un nacedero, donde sobresalía el árbol de totumo en el cual se divisó por primera vez el lienzo o tela que hoy tiene el cuadro original que reposa en el altar mayor del templo parroquial, con la imagen de nuestra señora de Chiquinquira; dese esta aparición, se consagró como la patrona de pueblo de Prado. 
...
__Advertencia:__ antes de llegar a la represa, tendrán que pasar un túnel por lo que deben de tener precaución, disminuir la velocidad, y pitar antes de entrar o escuchar si viene alguien pitando para reducir la velocidad. El túnel es muy angosto y solo puede pasar un carro a la vez.
...
En el municipio de Prado encontrarás una gran variedad de alojamientos, que normalmente valen 50.000$ por persona. Si planeas quedarte más de una noche en Prado, Tolima, te recomendamos que te quedes en algunas de las islas dentro de la presa en Prado.
Puede tomar el tour que tiene alojamiento, y si necesita una noche adicional puede informar en el momento de realizar el tour.
